...
#define LINGO_SLIDE_TEST  0x09         //零重力电机测试
...
#define LINGO_WAVER_TEST    0x18         //摇摆电机测试   add by taoqingsong 

//下面区域用于更新云端程序 modify by taoqingsong 
//------------------------------------------------------------------------
...
#define SYS_KEY_UP_RELEASE        (SYS_KEY_UP | SYS_KEY_RELEASE)   //释放按键
