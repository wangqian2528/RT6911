...
unsigned int KneadMotor_VoltageAdj(unsigned int setDuty)
{
  ...
  ADC_Get_Voltage(ADC_V24,&adc24);     //例如2800表示28V
  if(adc24 <= KNEAD_SET_VOLTAGE) //#define KNEAD_SET_VOLTAGE       2600
  {
  ...
  */
  ...
  unsigned int yushu = KNEAD_SET_VOLTAGE % adc24;
  setDuty = KNEAD_SET_VOLTAGE / adc24;
