...
#define KNOCK_MOTOR_ENBL_PORT   gpioPortA   //new 
#define KNOCK_MOTOR_ENBL_BIT    8
#define KNOCK_MOTOR_ENBL_MODE   gpioModePushPull

#define KNOCK_MOTOR_FAULT_PORT   gpioPortB  //new 
#define KNOCK_MOTOR_FAULT_BIT    2
#define KNOCK_MOTOR_FAULT_MODE   gpioModeInputPullFilter

#define KNOCK_MOTOR_PHASE_PORT   gpioPortB //new
#define KNOCK_MOTOR_PHASE_BIT    4
#define KNOCK_MOTOR_PHASE_MODE   gpioModePushPull

#define KNOCK_MOTOR_DECAY_PORT   gpioPortD //new
#define KNOCK_MOTOR_DECAY_BIT    1
...
#define KNOCK_MOTOR_RESET_PORT   gpioPortB
#define KNOCK_MOTOR_RESET_BIT    3
